...
export default async function FamilyDashboardPage({ searchParams }:{ searchParams:Promise<{child?:string}> }){
  ...
  const academyHref=selectedSlug?`/family/academy/world?child=${selectedSlug}`:"/family/academy/world";
